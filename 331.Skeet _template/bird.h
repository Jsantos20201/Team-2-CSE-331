...
#pragma once
#include "position.h"
#include "advanceTemplate.h"
#include "advanceFloater.h"
...
public:
   Bird() : dead(false), points(0), radius(1.0), advanceTemplate(nullptr) { }
   ...
   void setAdvanceTemplate(AdvanceTemplate* templatePtr) { advanceTemplate = templatePtr;}
